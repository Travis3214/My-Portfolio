      ...
      <div className="title">
        <div className="aboutPage">
          <div>
            ...
            <p>The course focused on Javascript and many of the framworks and libriaries that are widely used today.</p>
            <p>Throughout the course I worked individually on many front-end and back-end projects.</p>
            <p>I also got to work in groups on full-stack projects that we showed off to the class.</p>
          </div>
